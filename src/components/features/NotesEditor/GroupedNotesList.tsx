...
export function GroupedNotesList({ notes, title, onOpenModal }: GroupedNotesListProps) {
  ...
  // Usar a data do devocional em vez da data da nota
  const devotionalDate = notes[0]?.devotionals?.created_at 
    ? formatDate(notes[0].devotionals.created_at)
